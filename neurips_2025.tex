...
\begin{table}[!htb]
    ...
    \begin{tabular}{lcc|cc}
        \toprule
        \multicolumn{1}{c}{} & \multicolumn{2}{c}{\hspace{1cm}\(f_{\circ}\)} \hspace{1cm} & \multicolumn{2}{c}{\hspace{1cm}\(f_c\)}\\
        \midrule
        \multicolumn{1}{c}{} & \hspace{1cm}\(\mathcal{D}_M\) & \(\mathcal{D}_{p}\) \hspace{1cm} & \hspace{1cm} \(\mathcal{D}_M\) & \(\mathcal{D}_{p}\) \\
        \midrule
        heavy IoU    	&	\hspace{1cm}0.1510	&	0.2179\hspace{1cm} &	\hspace{1cm}0.1649	&	0.2604	\\
        medium IoU   	&	\hspace{1cm}0.2572	&	0.3417\hspace{1cm} &	\hspace{1cm}0.2786	&	0.3965	\\
        light IoU    	&	\hspace{1cm}0.3933	&	0.5054\hspace{1cm} &	\hspace{1cm}0.4395	&	0.5873	\\
        overall IoU  	&	\hspace{1cm}0.3483	&	0.4499\hspace{1cm} &	\hspace{1cm}0.3898	&	0.5250	\\
        \midrule
        precision   &	\hspace{1cm}0.6990	&	0.7875\hspace{1cm} &	\hspace{1cm}0.6942	&	0.7907	\\
        recall      &	\hspace{1cm}0.4098	&	0.5121\hspace{1cm} &	\hspace{1cm}0.4706	&	0.6098	\\
        \bottomrule
    \end{tabular}
\end{table}
