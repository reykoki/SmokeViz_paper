...
%\begin{table}
%    \caption{To create a true color image, we use the following bands from the ABI Level 1b Full Disk (ABI-L1b-RadF) product.}\label{rgb_bands}
%    \centering
%        \begin{tabular}{ccccrrcrc}
%            \toprule
%            band & description & center \(\lambda\) ($\mathrm{\mu m}$) & res (km)\\
%            \midrule
...
%\subsection{Thermometer Encoding Smoke Densities}
